...
| `n8n-devops-workflows` | "검증된 15개 워크플로우" | 디렉토리 스캐폴드는 있음 (`workflows/`, `templates/`, `credentials/`, `docs/`) | 2026-04-28 단일 커밋 (v1.0.0) |
...
- **n8n-devops-workflows** → **archive 보류**, `workflows/` 실제 내용 감사 후 결정 (별도 후속 작업)
